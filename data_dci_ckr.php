...
if ($startDate || $endDate) {
    $query = "CALL GetFilteredDCICkr($starting_limit_number, $results_per_page, ?, ?)";
} else {
    $query = "CALL GetDCIckr($starting_limit_number, $results_per_page)";
}
...
<body class="bg-gray-100 flex min-h-screen">
    ...
    <div id="main-content" class="main-content flex flex-col items-center">
        ...
        <div class="container absolute left-0 right-0 mx-auto max-w-[86vw] md:max-w-[90vw] lg:relative lg:left-auto lg:right-auto lg:mx-0 lg:max-w-[74vw]">
            <div class="flex mb-1 relative">
                <div class="w-1/2 pb-0">
                    <button id="showF" class="bg-gray-300 text-gray-800 font-semibold px-4 py-[6px] text-sm lg:px-4 lg:py-[10px] lg:text-lg rounded-md flex justify-start mt-10 items-center hover:bg-gray-400 transition-all">
                        <i class="fa-solid fa-filter"></i>
                        <span class="ml-2">Filter</span>
                    </button>
                    <form action="" method="get">
                        <div id="cardContainer" class="hidden p-6 mt-7 rounded-lg shadow-md absolute top-16 left-4 w-96 bg-white z-50">
                            <label class="block text-center text-gray-600 font-semibold py-2 bg-gray-200 rounded-t-lg">FILTER</label>
                            <div class="space-y-4 mt-4">
                                <div>
                                    <label for="startDate" class="block text-sm font-medium text-gray-700">Date:</label>
                                    <div class="flex space-x-4 mt-1">
                                        <input type="date" id="startDate" name="startDate" placeholder="Start Date" class="block w-full pl-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 lg:text-md">
                                        <input type="date" id="endDate" name="endDate" placeholder="End Date" class="block w-full pl-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 lg:text-md">
                                    </div>
                                </div>
                                <div class="flex space-x-4">
                                    <button type="reset" id="resetFilter" class="bg-gray-300 text-gray-800 font-semibold py-2 px-4 rounded-md hover:bg-gray-400 transition-all">Reset</button>
                                    <button type="submit" class="bg-gray-500 text-white font-semibold py-2 px-4 rounded-md hover:opacity-75 transition-all">Apply</button>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="w-1/2">
                    <a href="cetak_dci_ckr.php" class="absolute top-0 right-0 bg-gray-400 text-white mt-10 mx-5 px-4 py-2 text-sm rounded-lg hover:opacity-75 lg:py-[10px] lg:px-5 lg:text-lg transition duration-300">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Origin</th>
            ...
            <div class="pagination mt-4">
                ...
                <a href="data_dci_ckr.php?page=<?php echo $page; ?>"
