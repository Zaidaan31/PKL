...
$query = "SELECT COUNT(*) AS total FROM customer WHERE tujuan='CIKARANG'";
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-500">
                                    <?php echo htmlspecialchars($row['Pengirim']); ?>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-500">
                                    <?php echo htmlspecialchars($row['Penerima']); ?>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-500">
                                    <?php echo htmlspecialchars($row['Kuantitas']); ?>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-500">
                                    <?php echo htmlspecialchars($row['Berat']); ?>
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap text-sm text-gray-500">
            ...
            <div class="flex justify-between my-5">
                ...
                <div class="pagination">
                    <?php for ($page = 1; $page <= $number_of_pages; $page++): ?>
                        <a href="data_dci_ckr.php?page=<?= $page; ?>" class="bg-white hover:opacity-75 px-4 py-2 border"><?= $page; ?></a>
                    <?php endfor; ?>
                </div>
            </div>
        </div>
