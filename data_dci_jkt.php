...
$query = "SELECT COUNT(*) AS total FROM customer WHERE tujuan='JAKARTA'";
...
if ($total_results > 0) {
    ...
    $query = "CALL GetDCIjkt($starting_limit_number, $results_per_page)";
    $result = mysqli_query($koneksi, $query);
            ...
            <div class="flex justify-between my-5">
                ...
                <div class="pagination">
                    <?php for ($page = 1; $page <= $number_of_pages; $page++): ?>
                        <a href="data_dci_jkt.php?page=<?= $page; ?>" class="bg-white hover:opacity-75 px-4 py-2 border"><?= $page; ?></a>
                    <?php endfor; ?>
                </div>
            </div>
        </div>
