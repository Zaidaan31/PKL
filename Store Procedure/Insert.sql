-- Insert Cikarang
CREATE PROCEDURE `dco`.`InsertCkr`(
...
BEGIN
    ...
    INSERT INTO dco.barang(type, qty, weight)
    ...
    INSERT INTO dco.customer(tujuan, nama_pengirim, nama_penerima, tlp_pengirim, tlp_penerima,
...
-- Insert Bekasi
CREATE PROCEDURE `dco`.`InsertBks`(
    IN in_tujuan VARCHAR(50),
    IN in_pengirim VARCHAR(255),
    IN in_penerima VARCHAR(255),
    IN in_tlp_pengirim VARCHAR(13),
...
BEGIN
    ...
    INSERT INTO dco.barang_bks(type, qty, weight)
    VALUES(in_tipe_barang, in_qty, in_weight);
...
-- Insert Jakarta
CREATE PROCEDURE `dco`.`InsertJkt`(
    IN in_tujuan VARCHAR(50),
    IN in_pengirim VARCHAR(255),
    IN in_penerima VARCHAR(255),
    IN in_tlp_pengirim VARCHAR(13),
...
BEGIN
    ...
    INSERT INTO dco.barang_jkt(type, qty, weight)
    VALUES(in_tipe_barang, in_qty, in_weight);
...
-- Insert Depok
CREATE PROCEDURE `dco`.`InsertDpk`(
    IN in_tujuan VARCHAR(50),
    IN in_pengirim VARCHAR(255),
    IN in_penerima VARCHAR(255),
    IN in_tlp_pengirim VARCHAR(13),
...
BEGIN
    ...
    INSERT INTO dco.barang_dpk(type, qty, weight)
    VALUES(in_tipe_barang, in_qty, in_weight);
...
-- Insert Bogor
CREATE PROCEDURE `dco`.`InsertBgr`(
    IN in_tujuan VARCHAR(50),
    IN in_pengirim VARCHAR(255),
    IN in_penerima VARCHAR(255),
    IN in_tlp_pengirim VARCHAR(13),
...
BEGIN
    ...
    INSERT INTO dco.barang_bgr(type, qty, weight)
    VALUES(in_tipe_barang, in_qty, in_weight);
...
-- Insert Tanggerang
CREATE PROCEDURE `dco`.`InsertTgr`(
    IN in_tujuan VARCHAR(50),
    IN in_pengirim VARCHAR(255),
    IN in_penerima VARCHAR(255),
    IN in_tlp_pengirim VARCHAR(13),
...
BEGIN
    ...
    INSERT INTO dco.barang_tgr(type, qty, weight)
    VALUES(in_tipe_barang, in_qty, in_weight);
