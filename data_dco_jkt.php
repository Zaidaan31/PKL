...
$count_query = "SELECT COUNT(*) AS total 
                FROM trans tr
                INNER JOIN barang_jkt b ON tr.id_barang_jkt = b.id
...
if ($total_results > 0) {
    ...
    if ($destination || $startDate || $endDate) {
        $query = "CALL GetFilteredDatajkt($starting_limit_number, $results_per_page, '$destination', '$startDate', '$endDate')";
    } else {
        $query = "CALL GetDCOjkt($starting_limit_number, $results_per_page)";
    }
    ...
    <div id="main-content" class="main-content flex flex-col items-center">
        ...
        <div
            ...
            <div class="pagination mt-4">
                ...
                <a href="data_dco_jkt.php?page=<?php echo $page; ?>"
