...
$query = "SELECT COUNT(*) AS total FROM customer WHERE id_barang_dpk!=0";
            ...
            <div class="flex justify-between my-5">
                ...
                <div class="pagination">
                    <?php for ($page = 1; $page <= $number_of_pages; $page++): ?>
                        <a href="data_dco_dpk.php?page=<?= $page; ?>" class="bg-white hover:opacity-75 px-4 py-2 border"><?= $page; ?></a>
                    <?php endfor; ?>
                </div>
            </div>
        </div>
