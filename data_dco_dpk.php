...
$count_query = "SELECT COUNT(*) AS total 
                FROM trans tr
                INNER JOIN barang_dpk b ON tr.id_barang_dpk = b.id
...
if ($total_results > 0) {
    ...
    if ($destination || $startDate || $endDate) {
        $query = "CALL GetFilteredDatadpk($starting_limit_number, $results_per_page, '$destination', '$startDate', '$endDate')";
    } else {
        $query = "CALL GetDCOdpk($starting_limit_number, $results_per_page)";
    }
    ...
    <div id="main-content" class="main-content flex flex-col items-center">
        ...
        <div
            ...
            <div class="pagination mt-4">
                ...
                <a href="data_dco_dpk.php?page=<?php echo $page; ?>"
