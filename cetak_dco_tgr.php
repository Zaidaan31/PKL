...
$header = array('Service', 'Destination', 'Item Code', 'Transaction Code', 'Date', 'Customer Name', 'Recipient Name', 'Quantity', 'Weight', 'Total Amount');
