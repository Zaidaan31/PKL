            ...
            <nav class="flex flex-col w-full items-center justify-center space-y-2 mt-4">
                ...
                <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'finance ckr'): ?>
                    <a href="data_dco_ckr.php"
                        ...
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCO Cikarang</span>
                    </a>
                    <a href="data_dci_ckr.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCI Cikarang</span>
                    </a>
                <?php endif; ?>
                ...
                <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'finance bks'): ?>
                    <a href="data_dco_bks.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCO Bekasi</span>
                    </a>
                    <a href="data_dci_bks.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCI Bekasi</span>
                    </a>
                <?php endif; ?>
                ...
                <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'finance jkt'): ?>
                    <a href="data_dco_jkt.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCO Jakarta</span>
                    </a>
                    <a href="data_dci_jkt.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCI Jakarta</span>
                    </a>
                <?php endif; ?>
                ...
                <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'finance dpk'): ?>
                    <a href="data_dco_dpk.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCO Depok</span>
                    </a>
                    <a href="data_dci_dpk.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCI Depok</span>
                    </a>
                <?php endif; ?>
                ...
                <?php if ($_SESSION['level'] == 'admin' || $_SESSION['level'] == 'finance bgr'): ?>
                    <a href="data_dco_bgr.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCO Bogor</span>
                    </a>
                    <a href="data_dci_bgr.php"
                        class="flex items-center py-2 px-4 w-full text-white hover:bg-gray-500 transition duration-300">
                        <i class="fas fa-database text-lg"></i>
                        <span class="ml-3 justify-center font-bold text-sm lg:text-base">DCI Bogor</span>
                    </a>
                <?php endif; ?>
